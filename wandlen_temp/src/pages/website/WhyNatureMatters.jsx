...
import NatureWalking from "../../assets/NatureWalking.jpg";
            ...
            <div className="flex flex-col items-start gap-4 mt-10">
              <div className="flex flex-col items-start gap-5">
                <div className="w-full text-brown text-left font-[Poppins] text-base sm:text-lg md:text-2xl leading-[136%]">
                  {t("whyNatureMatters.content.main")}
                </div>
                <div className="w-full text-brown text-left font-[Poppins] text-base sm:text-lg md:text-2xl leading-[136%]">
                  <div className="  text-black text-justify font-['Poppins'] text-xl leading-[180%]">
                    <h2 className="text-2xl font-semibold mb-4 text-brown">
                      {t("whyNatureMatters.content.subtitle")}
                    </h2>
                    <ul className="list-disc list-inside space-y-2">
                      {t("whyNatureMatters.content.benefits", {
                        returnObjects: true,
                      }).map((benefit, index) => (
...
export default WhyNatureMatters;
