              ...
              <div className="space-y-6 md:space-y-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#ede4dc] text-base md:text-lg font-['Poppins']">
                      {t("videoTraining.practicalInfo.location.address")}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#ede4dc] text-base md:text-lg font-['Poppins']">
                      {t("videoTraining.practicalInfo.time.schedule")}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#ede4dc] text-base md:text-lg font-['Poppins']">
                      {t("videoTraining.practicalInfo.audience.description")}
                    </p>
                  </div>
                </div>
              </div>
