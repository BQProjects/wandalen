...
const ClientHeader = () => {
  ...
  return (
    <div className="flex justify-between items-center px-4 md:pl-[4.5rem] md:pr-[4.5rem] p-4 bg-[#ede4dc] relative">
      ...
      <button
        className="md:hidden flex flex-col justify-center items-center w-8 h-8 space-y-1 hamburger-menu-btn"
      ...
      <div className="hidden md:flex items-center gap-6">
        ...
        >
          <div className="body text-[#381207] font-poppins font-medium text-xl leading-[136%]">
            {t("clientHeader.navigation.welcome")}
          </div>
        ...
        >
          {t("clientHeader.buttons.logout")}
        </button>
      </div>

      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-[#ede4dc] shadow-lg z-40 mobile-menu-container">
