...
const WebsiteHeader = () => {
  const { userType, isAuthenticated, logout } = useContext(AuthContext);
  ...
  return (
    <div className="flex justify-between items-center px-4 sm:px-6 md:px-8 lg:px-12 xl:px-18 py-4 bg-secondary relative">
      ...
      <div className="flex items-center gap-6">
        ...
        <button
          className="md:hidden flex flex-col justify-center items-center w-8 h-8 space-y-1 ml-auto"
            ...
            {isAuthenticated ? (
              <>
                ...
                <button
                  ...
                  className="py-2 px-4 rounded-lg bg-brown text-white font-['Poppins'] text-lg font-medium hover:bg-brown-hover transition-colors"
                >
                  {t("header.logout")}
                </button>
              </>
            ...
            <div className="relative" ref={mobileLanguageMenuRef}>
              ...
              {isMobileLanguageMenuOpen && (
                <div className="absolute top-full mt-2 left-1/2 transform -translate-x-1/2 bg-secondary border border-[#381207] rounded-lg shadow-lg z-50 min-w-[150px]">
                  <button
                    onClick={() => changeLanguage("en")}
                    className={`block w-full text-left px-4 py-2 hover:bg-[#f0ebe7] font-poppins text-lg font-medium ${
                      i18n.language === "en"
                        ? "bg-[#381207] text-[#f0ebe7]"
                        : "text-[#381207]"
                    }`}
